...
public class Alpha {
    public static void main(String[] args) throws IOException {
        ...
        CourseDatabase.setBounds(130,258,133, 35); // İndirilenleri görüntülemek için koordinatlar.
        ...
        CourseName.setBounds(130,175,55,35);

        JLabel PlusSign = new JLabel("+"); //Ekrandaki yerini sonra belirleyeceğiz.
        PlusSign.setBounds(190,185,10,10); // Uyarı yazısının bölgesini ve boyutunu yazıyoruz.
        ...
        CourseCode.setBounds(205,175,55,35);
